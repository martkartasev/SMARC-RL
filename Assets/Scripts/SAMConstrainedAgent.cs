...
namespace DefaultNamespace
{
    ...
    public class SAMConstrainedAgent : SAMGeneralMovementLearningAgent
    {
        ...
        protected override float ComputeReward()
        {
            ...
            reward += 0.2f * Mathf.Min(collisionPool.collisionReward + collisionGlass.collisionReward, -1) / MaxStep; //Collisions return -1 if colliding, if both collide, only apply a total of -1;
            return reward;
        }
