...
namespace DefaultNamespace
{
    ...
    public class SAMConstrainedAgent : Agent
    {
        ...
        public CollisionRewarder poolRewarder;
        public CollisionRewarder glassRewarder;
        ...
        {
            Vector3 newPos = new Vector3(Random.Range(-2.8f, 2.8f), Random.Range(-0, 2.35f), Random.Range(-1.4f, 1.4f));
        ...
        private void InitializeTarget()
        {
            ...
            targetObject.localPosition = new Vector3(Random.Range(-3.2f, 3.2f), Random.Range(0.3f, 2.35f), Random.Range(-2f, 2f));
